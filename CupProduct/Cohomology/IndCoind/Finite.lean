...
def ind₁'_π : ind₁' ⟶ 𝟭 (Rep R G) where
  ...
  naturality _ _ x := by
    ...
    simp only [Functor.id_obj, ind₁', ModuleCat.hom_ofHom, mapRange.linearMap_apply, coe_hom,
      ind₁'_π_apply, Module.End.one_apply, implies_true, sum_mapRange_index, hom_apply]
